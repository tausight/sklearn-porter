...
class RandomForestRegressor(Regressor):
    ...
    def __init__(self, estimator, target_language='java',
        ...
        :param estimator : RandomForestRegressor
            An instance of a trained RandomForestRegressor estimator.
        ...
        if not isinstance(estimator.base_estimator, DecisionTreeRegressor):
            msg = "The regressor doesn't support the given base estimator %s."
            raise ValueError(msg, estimator.base_estimator)

        # Check number of base estimators:
        if not estimator.n_estimators > 0:
            msg = "The regressor hasn't any base estimators."
